...
function DocumentReferred() {
  ...
  const handleSubmit = async () => {
    try {
      ...
      toast.success("New Document Details added successfully", { autoClose: 5000 });
      clearForm();
    } catch (error) {
      toast.error(`${error}`, {
        autoClose: 5000,
    ...
    <Box noValidate m={2} component="span" sx={{ mt: 1 ,width:500}}>
      <div>
        ...
        <DropDown
          ...
          setValue={(value) => setFormData({ ...formData, legalDocumentsDetails: value })}
        />
        ...
        <TextFieldComp
          ...
          isMultilined={false}
          setValue={(value) => setFormData({ ...formData, detailsOfLegalDocsReceived: value })}
        />
        <DropDown
          width = "50"
          className="textboxalignment"
        ...
        <DropDown
          ...
          setValue={(value) => setFormData({ ...formData, landHoldingType: value })}
        />
        <TextFieldComp
          width = "50"
        ...
        <DropDown
          ...
          setValue={(value) => setFormData({ ...formData, approvingAuthority: value })}
        />
        <DropDown
          width = "50"
          ...
          setValue={(value) => setFormData({ ...formData, withinMuncipalLimit: value })}
        />
        <DropDown
          width = "50"
          ...
          setValue={(value) => setFormData({ ...formData, sanctionPlanProvided: value })}
        />
        <TextFieldComp
          width = "50"
        ...
        <DropDown
          ...
          setValue={(value) => setFormData({ ...formData, numberOfFloorsApproved: value })}
        />
        <TextFieldComp
          width = "50"
