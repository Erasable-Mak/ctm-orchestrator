      ...
      <>
        <>
          ...
          <Box noValidate sx={{ mt: 1 }}>
            ...
            <DropDown
              ...
              setValue={(value) =>
                setFormData({ ...formData, zoneAsPerCityMasterPlan: value })
              }
            />
            <DropDown
              ...
              setValue={(value) =>
                setFormData({
                  ...formData,
                  InfrastructureOfTheSurroundingArea: value,
                })
              }
            />
            <DropDown
              ...
              setValue={(value) =>
                setFormData({ ...formData, NeighbourhoodType: value })
              }
            />
            <DropDown
              ...
              setValue={(value) =>
                setFormData({ ...formData, LocallyConnectiveFromBBD: value })
              }
            />
            <br />
            <DropDown
              ...
              setValue={(value) =>
                setFormData({ ...formData, ProximityToAmenities: value })
              }
            />
            <DropDown
              ...
              setValue={(value) =>
                setFormData({
                  ...formData,
                  MarketabilityEaseOfSaleability: value,
                })
              }
            />
            <TextFieldComp
            ...
            <TextFieldComp
              ...
              setValue={(value) =>
                setFormData({
                  ...formData,
                  ConditionAndWidthOfApproachRoad: value,
                })
              }
            />
            <TextFieldComp
              ...
              isMultilined={false}
              setValue={(value) =>
                setFormData({ ...formData, NameOfNearestBusStop: value })
              }
            />
            <TextFieldComp
              ...
              isMultilined={false}
              setValue={(value) =>
                setFormData({ ...formData, DistanceFromBankFIBranch: value })
              }
            />
            <TextFieldComp
              ...
              setValue={(value) =>
                setFormData({
                  ...formData,
                  DistanceFromLandmarkRailwayStation: value,
                })
              }
            />
            {/*Seacond box Table*/}
          ...
          <Box noValidate sx={{ mt: 1 }}>
            <div>
              <Divider textAlign="left">
                Building /Piot Boundaries & Dimension
              </Divider>
              <br />
            ...
            <DropDown
              ...
              setValue={(value) =>
                setFormData({ ...formData, BoundariesMatching: value })
              }
            />
          </Box>
          <br />
        ...
        <Box noValidate sx={{ mt: 1 }}>
          ...
          <TextFieldComp
            ...
            isMultilined={false}
            setValue={(value) =>
              setFormData({ ...formData, NameOfPersonMetAtSite: value })
            }
          />
          <TextFieldComp
            ...
            isMultilined={false}
            setValue={(value) =>
              setFormData({ ...formData, NameOfSocietyBoard: value })
            }
          />
          <DropDown
            ...
            setValue={(value) =>
              setFormData({ ...formData, PropertyOccupiedOrVacant: value })
            }
          />
          <DropDown
            ...
            setValue={(value) =>
              setFormData({
                ...formData,
                RelationshipOfOccupantWithCustomer: value,
              })
            }
          />
          <TextFieldComp
            ...
            isMultilined={false}
            setValue={(value) =>
              setFormData({ ...formData, NameOfOccupant: value })
            }
          />
          <TextFieldComp
            id="occupied-since"
            ...
            isMultilined={false}
            setValue={(value) =>
              setFormData({ ...formData, OccupiedSince: value })
            }
          />
          <TextFieldComp
            ...
            setValue={(value) =>
              setFormData({
                ...formData,
                NameOfReportedOwnerAsPerSiteInfo: value,
              })
            }
          />
        </Box>
