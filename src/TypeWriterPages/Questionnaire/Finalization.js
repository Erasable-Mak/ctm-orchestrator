        ...
        <Box noValidate sx={{ mt: 1 }}>
          <div>
            ...
            <TextFieldComp
              ...
              isMultilined={false}
              setValue={(value) =>
                setFormData({ ...formData, NetMortgageValueRs: value })
              }
            />
            <TextFieldComp
              ...
              isMultilined={false}
              setValue={(value) =>
                setFormData({ ...formData, NetMortgageValueInWords: value })
              }
            />
            <TextFieldComp
              ...
              isMultilined={false}
              setValue={(value) =>
                setFormData({ ...formData, RealisableValueRs: value })
              }
            />
            <TextFieldComp
              ...
              isMultilined={false}
              setValue={(value) =>
                setFormData({ ...formData, RealisableValueInWords: value })
              }
            />
            <TextFieldComp
              id="rental-per-month"
              ...
              isMultilined={false}
              setValue={(value) =>
                setFormData({ ...formData, RentalPerMonth: value })
              }
            />
            <TextFieldComp
              ...
              isMultilined={false}
              setValue={(value) =>
                setFormData({ ...formData, GovtReadyReckonerRate: value })
              }
            />
            <TextFieldComp
              id="insurable-value"
              ...
              isMultilined={false}
              setValue={(value) =>
                setFormData({ ...formData, InsurableValue: value })
              }
            />
            <TextFieldComp
              id="distress-value"
              ...
              isMultilined={false}
              setValue={(value) =>
                setFormData({ ...formData, DistressValue: value })
              }
            />
          </div>
        </Box>
        ...
        <Box noValidate sx={{ mt: 1 }}>
          <div>
            ...
            <TextFieldComp
              ...
              isMultilined={false}
              setValue={(value) =>
                setFormData({ ...formData, RecommendationStage: value })
              }
            />
          </div>
        </Box>
