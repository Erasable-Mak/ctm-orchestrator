        ...
        <Box noValidate sx={{ mt: 1 }}>
          <div>
            ...
            <DropDown
              ...
              setValue={(value) =>
                setFormData({ ...formData, PhysicalStatusOfProject: value })
              }
            />
            <TextFieldComp
              ...
              isMultilined={false}
              setValue={(value) =>
                setFormData({ ...formData, StageOfConstruction: value })
              }
            />
            <DropDown
              ...
              setValue={(value) =>
                setFormData({ ...formData, TypePropertyAsPerApprovals: value })
              }
            />
            <DropDown
              ...
              setValue={(value) =>
                setFormData({
                  ...formData,
                  PropertyUsageAsPerSiteObervation: value,
                })
              }
            />
            <DropDown
            ...
            <TextFieldComp
              ...
              isMultilined={false}
              setValue={(value) =>
                setFormData({ ...formData, ViolationObserved: value })
              }
            />
            <DropDown
              ...
              setValue={(value) =>
                setFormData({ ...formData, DetailsOfCommercialUsage: value })
              }
            />
            <TextFieldComp
              ...
              setValue={(value) =>
                setFormData({
                  ...formData,
                  FloorNoInCaseOfIndependentUnit: value,
                })
              }
            />
            <TextFieldComp
              ...
              setValue={(value) =>
                setFormData({
                  ...formData,
                  NoOfunitsPerFloorPositionOfUnits: value,
                })
              }
            />
            <DropDown
              ...
              setValue={(value) =>
                setFormData({ ...formData, RemarksOnviewFromProperty: value })
              }
            />
            <TextFieldComp
              ...
              isMultilined={false}
              setValue={(value) =>
                setFormData({ ...formData, AccommodationOfUnit: value })
              }
            />
            <TextFieldComp
              ...
              isMultilined={false}
              setValue={(value) =>
                setFormData({ ...formData, AmenitiesAvailableInSociety: value })
              }
            />
            <TextFieldComp
              ...
              isMultilined={false}
              setValue={(value) =>
                setFormData({ ...formData, ConstructionType: value })
              }
            />
            <TextFieldComp
              id="no-of-storeys"
              ...
              isMultilined={false}
              setValue={(value) =>
                setFormData({ ...formData, NoOfStoreys: value })
              }
            />
            <DropDown
              id="no-of-lifts"
              ...
              name="No of Lifts"
              setValue={(value) =>
                setFormData({ ...formData, NoOfLifts: value })
              }
            />
            <DropDown
              id="exterior"
              ...
              name="Exterior"
              setValue={(value) =>
                setFormData({ ...formData, Exterior: value })
              }
            />
            <DropDown
              id="interior"
              ...
              name="Interior"
              setValue={(value) =>
                setFormData({ ...formData, Interior: value })
              }
            />
            <TextFieldComp
              id="flooring"
              ...
              isMultilined={false}
              setValue={(value) =>
                setFormData({ ...formData, Flooring: value })
              }
            />
            <DropDown
              id="fittings"
              ...
              name="Fittings"
              setValue={(value) =>
                setFormData({ ...formData, Fittings: value })
              }
            />
            <DropDown
              id="door"
            ...
            <DropDown
              ...
              setValue={(value) =>
                setFormData({
                  ...formData,
                  MaintenanceLevelOfSocietyProject: value,
                })
              }
            />
            <TextFieldComp
            ...
            <TextFieldComp
              ...
              isMultilined={false}
              setValue={(value) =>
                setFormData({ ...formData, ResidualAge: value })
              }
            />
          </div>
        </Box>
        ...
        <Box noValidate sx={{ mt: 1 }}>
          <div>
            ...
            <TextField
              ...
              rows={4}
              setValue={(value) =>
                setFormData({ ...formData, EngineersRemark: value })
              }
            />
          </div>
        </Box>
